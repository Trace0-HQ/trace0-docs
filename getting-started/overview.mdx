...
<Steps>
  ...
  <Step title="Install the OpenTelemetry agent">
    ...
    <CardGroup cols={2}>
      <Card title="Java" icon="java" href="/setup/java/spring-boot">
        Java/Kotlin on ECS, K8s, Lambda, and more.
      </Card>
      <Card title="Node.js" icon="js" href="/setup/javascript/ecs">
