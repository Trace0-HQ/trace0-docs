...
## 4. Add Trace0 logger
To correlate logs with traces in Trace0, the [@trace0/otel-logger](https://www.npmjs.com/package/@trace0/lambda-otel-logger) library must be installed in your Lambda function. This is necessary because the OpenTelemetry Lambda layer for Node.js does not yet automatically bridge console output into the OTel Logs pipeline.
```json
"dependencies": {
